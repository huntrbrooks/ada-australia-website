    ...
    <section className="py-8 sm:py-12 lg:py-16 bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-12">
          <p className="text-blue-400 uppercase tracking-wide text-sm sm:text-base mb-2">ADA AUSTRALIA</p>
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-blue-600 uppercase mb-4 sm:mb-6">
            Three Pillars for Protection
          </h2>
          <p className="text-gray-700 max-w-4xl mx-auto text-sm sm:text-base lg:text-lg leading-relaxed px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div className="bg-white p-6 sm:p-8 rounded-lg shadow-sm text-center">
            <div className="w-12 h-12 sm:w-16 sm:h-16 bg-blue-100 rounded-lg flex items-center justify-center mx-auto mb-4 sm:mb-6">
              <Mouse className="w-6 h-6 sm:w-8 sm:h-8 text-blue-600" />
            </div>
            <h3 className="text-lg sm:text-xl font-bold text-blue-600 mb-3 sm:mb-4">
              Publications, Online Worker Wellbeing Hub
            </h3>
            <p className="text-gray-700 text-sm sm:text-base leading-relaxed">
          ...
          <div className="bg-white p-6 sm:p-8 rounded-lg shadow-sm text-center sm:col-span-2 lg:col-span-1">
            <div className="w-12 h-12 sm:w-16 sm:h-16 bg-blue-100 rounded-lg flex items-center justify-center mx-auto mb-4 sm:mb-6">
              <Headphones className="w-6 h-6 sm:w-8 sm:h-8 text-blue-600" />
            </div>
            <h3 className="text-lg sm:text-xl font-bold text-blue-600 mb-3 sm:mb-4">24/7 Direct Support</h3>
            <p className="text-gray-700 text-sm sm:text-base leading-relaxed">
