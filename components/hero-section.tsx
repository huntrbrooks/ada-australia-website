...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-[600px] bg-gradient-to-br from-slate-800 via-slate-700 to-slate-900 overflow-hidden">
      {/* Background Image */}
      <div
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[500px]">
                ...
                <div className="w-full h-full bg-white rounded-[2rem] overflow-hidden">
                  ...
                  <div className="p-6 h-full flex flex-col">
                    ...
                    <div className="text-center mb-8">
                      <div className="text-gray-400 text-sm mb-2">ADA</div>
                      <div className="text-gray-600 text-lg font-semibold">Well Connect</div>
                      <div className="text-gray-600 text-lg font-semibold">App</div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 flex-1">
                      ...
                      <div className="bg-gray-100 rounded-lg p-4 text-center">
                        ...
                        <div className="text-xs text-gray-600">Call us or</div>
                      ...
                      <div className="bg-gray-100 rounded-lg p-4 text-center">
                        ...
                        <div className="text-xs text-gray-600">Videos, Podcasts,</div>
                      ...
                      <div className="bg-gray-100 rounded-lg p-4 text-center">
                        ...
                        <div className="text-xs text-gray-600">My Work, Alerts,</div>
                      ...
                      <div className="bg-gray-100 rounded-lg p-4 text-center">
                        ...
                        <div className="text-xs text-gray-600">7 Flags Wellbeing</div>
          ...
          <div className="text-white space-y-6">
            <div className="space-y-2">
              <p className="text-sm font-medium tracking-wide uppercase">24/7 SUPPORT IN YOUR POCKET</p>
              <h1 className="text-4xl lg:text-5xl font-bold text-cyan-400 leading-tight">WELL CONNECT APP</h1>
            </div>
            ...
            <Button
              size="lg"
              className="bg-cyan-400 hover:bg-cyan-500 text-white rounded-full px-8 py-3 text-lg font-semibold"
            >
              Find out more
            </Button>
          </div>
